 ...
 const LoginComponent = () => {
   ...
   return (
     <SafeAreaView style={styles.containerStyle}>
       <View style={{ flex: 0.2 }}>{!!fetching && <ActivityIndicator color={orange} />}</View>
       ...
       <View style={styles.signInButtonContainerStyle}>
         <TouchableHighlight style={styles.signInButtonStyle} onPress={__doLogin} underlayColor={orange}>
           <View
             style={{
               flexDirection: "row",
               justifyContent: "space-around"
 ...
 const SigInComponent = () => {
   ...
   const __doCreateUser = async (email, password) => {
     try {
      ...
      createUser(email, x, user.uid);
      //firebase.firestore().collection("users").add({location: "Nijmegen", userType: "free"});
     });
   ...
   return (
     <SafeAreaView style={styles.containerStyle}>
       ...
       <View style={styles.signInButtonContainerStyle}>
         <TouchableHighlight style={styles.signInButtonStyle} onPress={__doSignUp} underlayColor={orange}>
           <View
             style={{
               flexDirection: "row",
               justifyContent: "space-around"
